...
EXECUTE_PROMPT = (
    ...
    "• `memory_list`: call when the user asks 'what do you know about me?', "
    "'show me your memories', or 'what have I told you before?'. "
    "Lists recent memories by recency without a search query.\n"
    ...
    "'episodic' for events. You may add tags=['work','personal',…] to label it. "
    "Store returns immediately; extraction runs in background.\n"
    "• `memory_update`: call when the user says 'that memory is wrong', "
    "'update what you know about X', or 'correct that'. "
    "Requires the episode_id from a prior memory_search or memory_list result.\n"
